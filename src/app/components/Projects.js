	...
	function individualProject() {
		return projectArray.reverse().map((indiv) => {
			return (
				<>
					<div
						className="flex flex-1 hover:bg-slate-700 my-3 md:px-3 shadow-transparent rounded-3xl bg-opacity-0 bg-slate-700 md:hover:bg-opacity-25 hover:shadow-2xl"
						key={indiv.id}>
